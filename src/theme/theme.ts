export type AppTheme = {
  ...
  supportRowBackground: string;
  supportRowBorder: string;
  supportRowText: string;
  textSizeBadgeBackground: string;
  textSizeBadgeText: string;
  statusTopStripColor: string;
...
export const morningTheme: AppTheme = {
  background: '#F6F1E8',
  textPrimary: '#2F352F',
...
export const eveningTheme: AppTheme = {
  background: '#0F1722',
  textPrimary: '#E6EAF0',
